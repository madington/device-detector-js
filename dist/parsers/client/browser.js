    ...
    constructor(options) {
        ...
        this.parse = (userAgent) => {
            ...
            for (const browser of browsers_json_1.default) {
                const match = (0, user_agent_1.userAgentParser)(browser.regex, userAgent);
                if (!match)
                    continue;
                const vrpVersion = (0, variable_replacement_1.variableReplacement)(browser.version, match);
                const version = (0, version_1.formatVersion)(vrpVersion, this.options.versionTruncation);
                const shortVersion = version && parseFloat((0, version_1.formatVersion)(vrpVersion, 1)) || "";
                if (browser.engine) {
                ...
                result.type = "browser";
                result.name = (0, variable_replacement_1.variableReplacement)(browser.name, match);
            ...
            result.engineVersion = (0, version_1.formatVersion)((0, version_1.parseBrowserEngineVersion)(userAgent, result.engine), this.options.versionTruncation);
            return result;
        };
